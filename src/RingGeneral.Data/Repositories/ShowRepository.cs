...
public sealed class ShowRepository : RepositoryBase
{
    ...
    public IReadOnlyList<SegmentTemplate> ChargerSegmentTemplates()
    {
        ...
        using var command = connexion.CreateCommand();
        command.CommandText = """
            SELECT TemplateId, Libelle, Description, TypeSegment, DureeMinutes, EstMainEvent, Intensite, MatchTypeId, SegmentsJson
    ...
    public IReadOnlyList<MatchType> ChargerMatchTypes()
    {
        ...
        using var command = connexion.CreateCommand();
        command.CommandText = """
            SELECT MatchTypeId, Libelle, Description, Actif, Ordre
            FROM MatchTypes
