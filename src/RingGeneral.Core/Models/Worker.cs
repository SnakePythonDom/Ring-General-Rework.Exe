...
namespace RingGeneral.Core.Models
{
    ...
    {
        /// <summary>
        /// Unique identifier (Legacy Integer ID)
        /// </summary>
        public int Id { get; set; }

        /// <summary>
        /// Global Unique Identifier (String ID)
        /// matches database 'WorkerId' column type
        /// </summary>
        ...
        // ====================================================================
        // LIFECYCLE & LEGACY (Phase 5)
        // ====================================================================

        /// <summary>
        /// Date of departure/retirement
        /// </summary>
        public DateTime? DepartureDate { get; set; }

        /// <summary>
        /// Reason for departure (Retirement, Expired, Fired)
        /// </summary>
        ...
        /// </summary>
        public bool IsHallOfFame { get; set; }

        /// <summary>
        /// Peak popularity/impact score for historical tracking
        /// </summary>
        ...
        /// <summary>
        /// Worker Type (Wrestler, Staff, Trainee)
        /// </summary>
        public WorkerType Type { get; set; } = WorkerType.Wrestler;
...
>>>>>>> temp-work
        ...
        /// <summary>
        /// Helper property: Is this worker a Wrestler?
        /// </summary>
        public bool IsWrestler => Type == WorkerType.Wrestler;

        /// <summary>
        /// Helper property: Is this worker a Staff member?
        /// </summary>
        public bool IsStaff => Type == WorkerType.Staff;

        /// <summary>
        /// Helper property: Is this worker a Trainee?
        /// </summary>
        public bool IsTrainee => Type == WorkerType.Trainee;

        /// <summary>
        /// Helper property: Is this worker a Loaned Wrestler?
        /// </summary>
        public bool IsLoanedWrestler => Type == WorkerType.LoanedWrestler;

        /// <summary>
        /// Helper property: Is this worker from a Child Company?
        /// </summary>
        public bool IsChildCompanyWorker => Type == WorkerType.ChildCompanyWrestler || Type == WorkerType.ChildCompanyStaff;
