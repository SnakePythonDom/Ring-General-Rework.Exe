namespace RingGeneral.Core.Models.Attributes
{
    ...
    public class WorkerMentalAttributes
    {
        ...
        // ====================================================================
        // ENGLISH ALIASES (For Interface Compatibility)
        // ====================================================================
        ...
        {
            get => Professionnalisme;
            set => Professionnalisme = value;
        }

        public int Sportsmanship
        {
            get => Sportivité;
            set => Sportivité = value;
        }
        ...
        {
            get => Adaptabilité;
            set => Adaptabilité = value;
        }

        public int Determination
        {
            get => Détermination;
            set => Détermination = value;
        }
