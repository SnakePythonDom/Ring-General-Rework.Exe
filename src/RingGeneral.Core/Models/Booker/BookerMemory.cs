...
public sealed record BookerMemory
{
    ...
    /// <summary>
    /// Identifiant de la compagnie au moment de la mémoire (requis par le schéma)
    /// </summary>
    [Required]
    public required string CompanyId { get; init; }

    /// <summary>
    /// Identifiant du worker concerné par l'événement (optionnel)
    /// </summary>
    ...
    public bool IsValid(out string? errorMessage)
    {
        ...
        var validEventTypes = new[]
        {
            ...
            "FanReaction", "OwnerFeedback", "ChampionshipDecision", "PushSuccess", "PushFailure"
        };
