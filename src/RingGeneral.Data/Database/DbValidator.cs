...
public sealed class DbValidator : IDbValidator
{
    private static readonly IReadOnlyDictionary<string, string[]> ColonnesObligatoires =
        new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["MedicalNotes"] = new[] { "MedicalNoteId", "WorkerId", "Note" },
            ["RecoveryPlans"] = new[] { "RecoveryPlanId", "InjuryId", "WorkerId", "TargetDate", "Status" },
            ["Fatigue"] = new[] { "WorkerId", "Value" },
            ["MedicalNotes"] = new[] { "MedicalNoteId", "WorkerId", "Week", "Content" },
            ["RecoveryPlans"] = new[] { "RecoveryPlanId", "InjuryId", "WorkerId", "StartWeek", "TargetWeek", "Status" },
