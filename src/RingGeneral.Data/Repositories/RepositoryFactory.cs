...
public static class RepositoryFactory
{
    ...
    public static RepositoryContainer CreateRepositories(SqliteConnectionFactory factory)
    {
        ...
        // Phase 5: Alumni
        var alumniRepository = new AlumniRepository(factory, workerRepository);
        ...
        // AI Decision Engines
        var ownerDecisionEngine = new OwnerDecisionEngine(ownerRepository);
        var bookerAIEngine = new BookerAIEngine(bookerRepository, relationsRepository);
